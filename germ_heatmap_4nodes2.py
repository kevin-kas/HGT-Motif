...
UC_germs=['1650663', '1965588', '745368', '301302', '1965581', '1891969', '1965549', '1965550', '1965639', '1834105', '622312', '411483', '1965655', '411471', '1965648', '1965551']
CD_germs=['1965631', '1965588', '1965581', '1965639', '762967', '1965551', '1834196', '537011', '1834112', '745368', '1891970', '1965650', '1965655', '411471', '1776047', '1834088', '1852381', '1531', '997894', '301302', '1203554', '1891969', '1776046', '1965549', '1965550', '411483', '2585118', '622312', '1650663', '1834105', '536231', '1965648', '1574262', '1033732']
non_germs=['1776045', '1965588', '1965581', '1834109', '1965639', '53378', '1965551', '537011', '665953', '745368', '1891970', '81858', '411471', '1776047', '1834088', '1891969', '1776046', '1965550', '411483', '449673', '46503', '1965648']
        ...
        for j in range(len(i)):
            if i[j]==0:
                ...
                if j==0:
                    ...
                    for n in range(i[j]):
                        new_list1.append((germs[0],germs[3]))
                elif j==3:
                    for n in range(i[j]):
                        new_list1.append((germs[1],germs[2]))
                elif j==4:
                    for n in range(i[j]):
                        new_list1.append((germs[1],germs[3]))
                elif j==5:
                    for n in range(i[j]):
                        new_list1.append((germs[2],germs[3]))
    return new_list1
...
middle_value = (CD_germs_df.max() - CD_germs_df.min()) / 2
color = sm.to_rgba(middle_value)

plt.figure(figsize=(20,20))
plt.gcf().autofmt_xdate()
plt.title('CD_germs with 4 nodes')
sns.heatmap(CD_germs_df, annot=False, fmt=".2f", cmap=cmap)
plt.show()
print(non_germs_df)